...
方法定义、重命名工具与裁图工具的 Tool 菜单动作追加、预览工具与标签过滤的 Tool 菜单运行时追加
...
## 热文件表（快照行数 = 2026-09-15）

| 文件 | 行数 | 说明 |
|---|---|---|
| `anylabeling/views/labeling/label_widget.py` | 7314 | 主窗口逻辑 + 全部挂载点 |
...
- `anylabeling/views/labeling/`：111 个 .py / 77331 行，含 8 个子包
